...
//
// #390 did that conversion, so those two now build a Local and ask it:
//
...
// will use those four composes them in the one auditable order this
// package's doc argues for below.
//
