...
// production entry points (Open here, and cmd/backupd's own
...
// bootstrap sequence Open (below) and cmd/backupd's own openService
...
// *state.Journal, which Open (below) and cmd/backupd's openService
