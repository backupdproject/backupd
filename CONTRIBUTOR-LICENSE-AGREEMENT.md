# retnd Individual Contributor License Agreement
...
its kind. It is here so that both sides know, in writing, what happens to code
contributed to this project.

**This is a template, not legal advice.** If you are contributing on behalf of
an employer, or you are unsure whether you own what you are contributing, get
your own advice before signing. If you are contributing as part of your
employment, your employer may own the copyright and you may need a corporate
agreement instead. Ask, and one will be produced.

---

Thank you for your interest in retnd, owned by Roman Goldmann ("the
...
Contributions submitted to the Project Owner. Except for the licence granted
here, **You reserve all right, title and interest in and to Your
Contributions.**
...
by You for inclusion in, or documentation of, this project. "Submitted" means
...
systems, excluding communication that is conspicuously marked or otherwise
...
to this project, or that Your employer has executed a separate corporate
agreement.
...
**This matters here more than the boilerplate suggests.** This project ships a
generated licence inventory and a NOTICE file that claim to account for every
piece of third-party material in the tree. A Contribution that quietly carries
somebody else's code makes those documents false, and they are the documents
recipients rely on.

## 6. You are not expected to provide support
...
## 7. Notify the Project Owner if anything above stops being accurate
...
Fill this in and include it in your first pull request as
`contributors/<your-github-username>.md`. One signature covers every
Contribution you make afterwards, so you do this once.
...
I have read the retnd Individual Contributor License Agreement and I
agree to it for this and all my future Contributions to this project.

Signed:
```

Typing your name into the `Signed:` line, in a commit authored by you, is the
signature. There is nothing to print, scan or post.
