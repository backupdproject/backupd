...
|---|---|---|---|
| 1 | A Go application embeds rclone successfully | PASS | `go build ./...` on this module; `cmd/retnd` links against the pinned rclone v1.75.0 with no CGO. |
