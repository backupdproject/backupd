...
**If you take the file route, take it before the click.** ZimaOS starts the stack the
...
reads on its first start. Put it there over SSH or through the ZimaOS file manager, in
