...
// core/cmd/retnd/daemon_signal_test.go uses for `daemon`, and
...
// core/cmd/retnd/daemon_signal_test.go pins "daemon_stop": what
...
const serveShutdownNotice = "retnd-web: shutdown complete"
...
// writeServeTestConfig mirrors core/cmd/retnd/main_test.go's own
...
reading:
	...
	// nothing at all.
	if !strings.Contains(stderr.String(), "retnd-web: runtime profile") {
