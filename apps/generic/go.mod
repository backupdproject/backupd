module github.com/retnd/retnd/apps/generic

go 1.27.0

require (
	github.com/retnd/retnd/apps/common v0.0.0-00010101000000-000000000000
...
// core/ and apps/common/ are sibling modules in this monorepo, not (yet)
...
replace github.com/retnd/retnd/apps/common => ../common
