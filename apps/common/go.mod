...
// core/ is a sibling module in this monorepo, not (yet) published anywhere
// go.sum could verify a checksum against. This replace is what makes
// "apps/common/go.mod's own module pin is correct" true on its own, with
