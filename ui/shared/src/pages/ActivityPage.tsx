  ...
  const loadOlder = useCallback(() => {
    ...
    api
      ...
      .catch((e: unknown) => {
        ...
        setOlderFailure(describeFailure(e, "retnd could not read older events.").message);
      })
    ...
    return (
      <>
        ...
        <EmptyState title="No activity yet" tip="activity.page.empty-unconfigured">
          retnd records what it does here. It has done nothing yet, because this
 ...
 *
 * The deployment this exists for reaches the operator as "retnd
