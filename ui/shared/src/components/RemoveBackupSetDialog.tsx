...
export function RemoveBackupSetDialog({
  ...
  return (
      ...
      onConfirm={() => {
        ...
        void api
          ...
          .catch((e: unknown) => {
            ...
            setError(
              describeFailure(e, "retnd could not remove this backup set's configuration.")
                .message
            );
          })
          .finally(() => {
    ...
    >
      <p style={{ margin: 0 }}>
        {"retnd will stop collecting backups for " + set.name + "."}
      </p>
      ...
      <p style={{ margin: 0, color: "var(--text-2)" }}>
        {set.retainedCount === null || set.retainedBytes === null
          ? "Retained backups stay on NAS storage and remain listed under Backups. retnd cannot say how many there are for this set."
