...
import type { RetndApi } from "./contracts";

const Ctx = createContext<RetndApi | null>(null);
...
export function ApiProvider({ api, children }: { api: RetndApi; children: ReactNode }) {
 ...
 */
export function useApi(): RetndApi {
