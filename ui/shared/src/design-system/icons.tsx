...
export const ICON_ARTWORK: Record<IconName, IconArtwork> = {
  ...
  /** EPIC K's Repositories nav row (issue #788). New artwork rather than
   *  a second use of an existing shape: this nav already learned once
   *  what two rows drawn as one shape cost, and a repository domain is a
   *  store rather than a set or a file. */
  "repositories": {
