...
import type { ArtifactReinstatement, RetndApi } from "@shared/api/contracts";
...
function renderPage(api: RetndApi, reload: () => void, readOnly = false) {
...
describe("QuarantinePage: the three reinstatement outcomes stay visibly different", () => {
  ...
  async function confirm(api: RetndApi, reload: () => void) {
